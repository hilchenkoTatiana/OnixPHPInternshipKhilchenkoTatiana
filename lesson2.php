...
abstract class Product
{
    ...
    function __construct($userName, $userBalance, $productName, $productPrice)
    {
        $this->name = $productName;
        $this->price = $productPrice;
        $this->owner = new User($userName, $userBalance);
    }
...
class Processor extends Product
{
    ...
    function __construct($userName, $userBalance, $productName, $productPrice, $userFrequency)
    {
        $this->frequency = $userFrequency;
        parent::__construct($userName, $userBalance, $productName, $productPrice);
    }
}
...
class Ram extends Product
{
    ...
    function __construct($userName, $userBalance, $productName, $productPrice, $productType, $productMemory)
    {
        parent::__construct($userName, $userBalance, $productName, $productPrice);
...
$ram = new Ram("Adam", 1000, "some", 10, "someType", 20);
$proc = new Processor("Tatiana", 600, "Intel", 200, 3.3);
